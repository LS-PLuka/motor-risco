...
public final class EventoFixture {
    ...
    public static TransacaoEventoDTO evento(BigDecimal valor, LocalDateTime dataHora, LocalDateTime contaCriadaEm) {
        return evento(valor, "BRA", dataHora, contaCriadaEm);
    }

    public static TransacaoEventoDTO evento(BigDecimal valor, String codigoPais,
                                            LocalDateTime dataHora, LocalDateTime contaCriadaEm) {
